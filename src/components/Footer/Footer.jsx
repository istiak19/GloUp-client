...
const Footer = () => {
    return (
        <footer className="footer bg-[#F63E7B] text-white p-10">
            <aside>
                {/* <div>
    <img src={logoPic} alt="" />
</div> */}
            ...
            <nav>
                ...
                <p>A modern beauty and wellness brand dedicated <br /> to enhancing your natural glow. <br /> From skincare to styling, GloUp offers premium services <br /> tailored to make you look and feel your best every day. 🌟</p>
